...
For this tutorial we start by using the `London.Pop` object again that we created during our tutorial in [Week 01](understanding-data.html#r-script) and that we also briefly used during [last week's tutorial](examining-data-i.html#measures-of-central-tendency). You may still have it loaded into your R workspace if your RStudio Server session is still active. To check if you do, you can use the `ls()` command as usal to get a list of all objects that are available in your RStudio session.
...
#### Questions {-}
1. Why we have to use double quotes (`''`) to subset out dataframe to get all rows that contain `00AG`?
...
#### Seminar task {-}
1. Create a histogram for the London borough of Ealing (Borough code `00AJ`), you need to:
- Use the `ggplot2` library.
- Add a title using `ggtitle()`.
- Change the colour of the visualisation.
- Use a bin width of 75.

2. Create a histogram for the London borough of Ealing (Borough code `00AJ`), you need to:
- Use the `ggplot2` library.
- Add a title using `ggtitle()`.
- Change the colour of the visualisation.
- Use a bin width of 100.

3. Create a boxplot for the London borough of Croydon (Borough code `00AH`), you need to:
- Use the `ggplot2` library.
- Add a title using `ggtitle()`.
- Change the colour of the visualisation.
...
- Box and whisk plot
- Line chart
2. Compare the results of the histograms you created for the borough of Ealing using a bin width of 75 with the histogram you created for the borough of Ealing using a bin width of 100. Why do they look so different? What does this tell you about the selection of bin widths?
