...
Now we now a little more about variables, we can go back to RStudio. Until now our objects have been extremely simple **integers** (i.e. whole numbers), but the real power of R comes when we can begin to execute functions on objects. 
