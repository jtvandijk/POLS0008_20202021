...
## Introduction
Welcome to your first week of **Introduction to Quantitative Research Methods**. This week we will focus on **understanding data**.

<div class="note">
Before you continue, make sure you have read through the details on the [welcome page](index.html) and have watched the course introduction video.
</div>

This week is structured by **3** short lecture videos, practical material that you need to do in preparation for Thursday's seminar, and a seminar task. You can find this week's [compulsory reading material]({#reading-list-w01) below.

Let's get started.

### Video: Introduction W01 {#introduction_w01}
...
Some tips about how to get the best of the forum:
