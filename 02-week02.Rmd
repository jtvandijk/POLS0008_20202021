...
## Introduction
Welcome to your second week of **Introduction to Quantitative Research Methods**. This week we will focus on **examining data** using descriptive statistics and measures of dispersion. We will also talk about some basic data visualisation. 
...
<div class="note">
If you are running RStudio on your own computer: when you hit enter R could ask you to select a [mirror](https://en.wikipedia.org/wiki/Mirror_site) to download the package contents from. It does not really matter which one you choose, but we would suggest you pick the mirror that is geographically closest to you.
</div>
