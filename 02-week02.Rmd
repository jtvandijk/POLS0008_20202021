...
As explained in the video, we can also visually represent our range, median, and interquartile range using a box and whisker plot:
...
<div class="note">
Creating a new object from an existing object is called a **subset**. There are many ways of creating a subset, but one way of doing it is by using the following syntax: `London.Assault[London.Assault$WardType == 'Multicultural Metropolitan',]`.
</div>
